<section id="comments">
	...
	<?php if ( post_password_required() ) : ?>
		<p><?php _e( 'This post is password protected. Enter the password to view any comments.', 'wpbootstrap2' ); ?></p>
	<?php return; endif; ?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<h3 id="comments-title">
			<?php printf( _n( 'One comentario to %2$s', '%1$s comentarios to %2$s', get_comments_number(), 'wpbootstrap2' ), number_format_i18n( get_comments_number() ), '' . get_the_title() . '' ); ?>
		</h3>
	...
	<?php else : // or, if we don't have comments: ?>
		...
		<?php	if ( ! comments_open() ) : ?>
			<p><?php _e( 'Comments are closed.', 'wpbootstrap2' ); ?></p>
